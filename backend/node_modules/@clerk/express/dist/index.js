...
var clerkClient = new Proxy(clerkClientSingleton, {
  get(_target, property) {
    ...
    const client = (0, import_backend.createClerkClient)({ ...env, userAgent: `${"@clerk/express"}@${"2.0.1"}` });
    if (env.secretKey) {
...
var authenticateAndDecorateRequest = (options = {}) => {
  ...
  const proxyPath = (0, import_proxy.stripTrailingSlashes)(frontendApiProxy?.path ?? import_proxy.DEFAULT_PROXY_PATH);
